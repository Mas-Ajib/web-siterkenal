<!-- resources/views/admin/layanan/pengaduan/narkoba.blade.php -->
@extends('layouts.admin')

@section('title', 'Pelaporan Penyalahgunaan Narkoba')

@section('content')
<div class="mb-6 flex justify-between items-center">
    <h1 class="text-2xl font-bold text-gray-900">Pelaporan Penyalahgunaan Narkoba</h1>
    <div class="flex space-x-3">
        <a href="{{ route('admin.layanan.pengaduan.narkoba.export') }}" 
...
<div class="bg-white rounded-lg shadow">
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex justify-between items-center">
            <h3 class="text-lg font-semibold text-gray-900">Data Pelaporan Narkoba</h3>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500 max-w-xs">
                        <div class="truncate" title="{{ $item->tempat_kejadian }}">
                            {{ Str::limit($item->tempat_kejadian, 50) }}
                        </div>
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-500 max-w-xs">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                        <a href="{{ route('admin.layanan.pengaduan.narkoba.edit', $item->id) }}" 
                           class="text-blue-600 hover:text-blue-900 inline-flex items-center">
                           <i class="fas fa-edit mr-1"></i>Edit
                        </a>
                        <form action="{{ route('admin.layanan.pengaduan.narkoba.destroy', $item->id) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" 
                ...
                <tr>
                    <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">
                        <i class="fas fa-inbox mr-2"></i>Tidak ada data pelaporan narkoba.
                    </td>
                </tr>
                @endforelse
            </tbody>
