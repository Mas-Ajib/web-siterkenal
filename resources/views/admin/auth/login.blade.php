...
<body class="min-h-screen flex items-center justify-center p-4">
    <div
        class="max-w-md w-full bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 relative overflow-hidden fade-in">
        <!-- Subtle decorative elements for better look (adjusted to blue tones) -->
        <div
            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-500/20 to-blue-300/20 rounded-full -mr-16 -mt-16">
        </div>
        <div
            class="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-blue-400/10 to-blue-200/10 rounded-full ml-8 mb-8">
        </div>

        <div class="text-center mb-8 relative z-10">
            <div class="flex justify-center items-center">
                <img src="{{ asset('images/logo-bnn.png') }}" alt="Logo BNN" class="h-16 w-auto">
            </div>
        ...
        @if ($errors->any())
            <div
                class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl mb-6 fade-in animation-delay-200">
